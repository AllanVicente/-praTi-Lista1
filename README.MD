# 📘 Exercícios – Lista 1 do Bootcamp Fullstack (+praTi)

Este repositório contém os códigos desenvolvidos como parte da **primeira lista de exercícios do Bootcamp Fullstack**, oferecido pela **instituição +praTi**.  
